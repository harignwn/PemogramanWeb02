      ...
      <ul class="nav">
        ...
        <li class="nav-item menu-items">
          ...
          <div class="collapse" id="ui-basic">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="produk.php">Daftar Produk</a></li>
        ...
        <li class="nav-item menu-items">
            ...
            <div class="collapse" id="auth">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="FormProduk.php"> Produk </a></li>
                <li class="nav-item"> <a class="nav-link" href="FormKategori.php"> Kategori </a></li>
          </ul>
            </div>
          </li>
