...
<body>
    <div class="container">
        ...
        @endphp
        <h1>Siswa {{ $nama }} dengan tanggal periksa {{ $tanggal_periksa }} dan tanggal lahir {{ $tanggal_lahir }} jenis kelamin {{$jk}}</h1><br>
        <h1>Memeiliki <br> tekanan darah : {{$tekanan_darah}} <br> Asam Urat {{$asam}} <br> Kolesterol :{{$kolesterol}} <br> Gula Darah : {{$gula}}</h1>
    </div>
