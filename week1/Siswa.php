...
<html lang="en">
  ...
  <tbody>
    <!-- number_format(variavel angka, nilai desimal brp, dipisahkan dengan koma,. tiap ribuan dengan titik) -->
      <!-- <= sama aja dengan php pada echo -->
      <!-- menampilkan data dengan php -->
<?php 
foreach ($kumpulan_nilai as $nilais):?>

    <tr>
        <?php $nilai_akhir =  ($nilais["uts"] +  $nilais["uas"]+ $nilais["tugas"])/3; ?>
        <td><?php echo $nilais["id"] ?></td>
        <td><?= $nilais["nim"] ?></td>
        <td><?php echo $nilais["uts"] ?></td>
        <td><?php echo $nilais["uas"] ?></td>
        <td><?php echo $nilais["tugas"] ?></td>
